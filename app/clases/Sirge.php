...
class SIRGe {
	...
	public static function getIdProvincia($provincia) {
		$id_provincia;
		switch ($provincia) {
			case 'CIUDAD DE BUENOS AIRES':$id_provincia = '01';
				break;
			case 'BUENOS AIRES':$id_provincia = '02';
				break;
			case 'CATAMARCA':$id_provincia = '03';
				break;
			case 'CÓRDOBA':$id_provincia = '04';
				break;
			case 'CORRIENTES':$id_provincia = '05';
				break;
			case 'ENTRE RIOS':$id_provincia = '06';
				break;
			case 'JUJUY':$id_provincia = '07';
				break;
			case 'LA RIOJA':$id_provincia = '08';
				break;
			case 'MENDOZA':$id_provincia = '09';
				break;
			case 'SALTA':$id_provincia = '10';
				break;
			case 'SAN JUAN':$id_provincia = '11';
				break;
			case 'SAN LUIS':$id_provincia = '12';
				break;
			case 'SANTA FE':$id_provincia = '13';
				break;
			case 'SANTIAGO DEL ESTERO':$id_provincia = '14';
				break;
			case 'TUCUMÁN':$id_provincia = '15';
				break;
			case 'CHACO':$id_provincia = '16';
				break;
			case 'CHUBUT':$id_provincia = '17';
				break;
			case 'FORMOSA':$id_provincia = '18';
				break;
			case 'LA PAMPA':$id_provincia = '19';
				break;
			case 'MISIONES':$id_provincia = '20';
				break;
			case 'NEUQUÉN':$id_provincia = '21';
				break;
			case 'RÍO NEGRO':$id_provincia = '22';
				break;
			case 'SANTA CRUZ':$id_provincia = '23';
				break;
			case 'TIERRA DEL FUEGO':$id_provincia = '24';
				break;
		}
		return $id_provincia;
	}
	...
	public static function selectProvincia($id_Html, $id_provincia = null) {
		...
		foreach ($data as $index => $valor) {
			...
			$Html .= $id_provincia != '25' ? ($id_provincia == $valor['id_provincia'] ? '' : 'disabled="disabled"') : '';
