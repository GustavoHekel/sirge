...
<body style="margin: 0;mso-line-height-rule: exactly;padding: 0;min-width: 100%;background-color: #fbfbfb">
    ...
    .wrapper .one-col-feature p,
    .wrapper .one-col-feature ol,
    .wrapper .one-col-feature ul {
        line-height: 32px
    }
    ...
    .wrapper .one-col-feature p a,
    .wrapper .one-col-feature ol a,
    .wrapper .one-col-feature ul a {
                ...
                <tr>
                    <td style="padding: 0;vertical-align: top">
                        <table style="border-collapse: collapse;border-spacing: 0;width: 602px">
                            <tbody>
                                <tr>
                                    <td class="title" style="padding: 0;vertical-align: top;padding-top: 10px;padding-bottom: 12px;font-size: 12px;line-height: 21px;text-align: left;color: #999;font-family: Georgia,serif">{MAIL}</td>
                                    <td class="webversion" style="padding: 0;vertical-align: top;padding-top: 10px;padding-bottom: 12px;font-size: 12px;line-height: 21px;text-align: right;width: 300px;color: #999;font-family: Georgia,serif">
                                        <webversion style="font-weight:bold;text-decoration:none;">{FECHA}</webversion>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <tbody>
                ...
                <tr>
                    <td class="logo" style="padding: 32px 0;vertical-align: top;mso-line-height-rule: at-least">
                        <div class="logo-center" style="font-size: 26px;font-weight: 700;letter-spacing: -0.02em;line-height: 32px;color: #41637e;font-family: sans-serif;text-align: center" align="center" id="emb-email-header"><img style="border: 0;-ms-interpolation-mode: bicubic;display: block;Margin-left: auto;Margin-right: auto;max-width: 295px" src="http://192.6.0.118/sirge2/public/img/sumar-grande.png" alt="" width="120" height="120" /></div>
                    </td>
                </tr>
            </tbody>
        </table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
                                                        <h2 style="Margin-top: 0;color: #565656;font-weight: 700;font-size: 28px;Margin-bottom: 18px;font-family: sans-serif;line-height: 42px;  font-style: italic;">De: {NOMBRE_FROM}</h2>
                                                        <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 15px;line-height: 25px;Margin-bottom: 25px">{BODY}</p>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                        ...
                        <table style="border-collapse: collapse;border-spacing: 0">
                            ...
                            <span>
                              <preferences style="font-weight:bold;text-decoration:none;" lang="en">
                                Enviado desde SIRGE Web
                              </preferences>
                              <span class="hide">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
                                                            </span>
                                                            </span>
                                                            <span class="block"><unsubscribe style="font-weight:bold;text-decoration:none;">Programa SUMAR</unsubscribe></span>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
