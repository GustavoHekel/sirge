...
if (isset($_POST['year'])) {
	...
	$_SESSION['grupo'] == 25 ? $data = $inst_comp_anual->getGraficoFacturacionTotal($_POST['year']) : $data = $inst_comp_anual->getGraficoFacturacion($_SESSION['grupo'], $_POST['year']);
	...
	$Html = array(
		'../../vistas/compromiso_anual/facturacion.html',
	);
